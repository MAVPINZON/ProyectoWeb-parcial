<%-- 
    Document   : PosibleClientes
    Created on : 2/12/2020, 03:16:23 PM
    Author     : DELL
--%>
...
<html>
    ...
    <body>
        ...
        <div class="container">
            <div class="card mx-auto nt-5">
                <div class="card-header">Crear Posibles Clientes</div>
                <div class="card-body">
                    <form action="PosibleClientesController" method="POST">
                        <!--FILA-->
                        ...
                        <div clas="form-group">
                            <div class="form-row">
                                ...
                                <!--COLUMNA-->
                                <div class="col-md-3">
                                    <label name="lblIngresosAnueales">Ingresos anuales</label>
                            ...
                            <div class="form-row">
                                ...
                                <div class="col-md-12">
                                    <table class="table table-bordered 
                                           table-primary table-responsive">
                                        <!--FILA-->
                                        <tr>
                                            <!--COLUMNA-->
                                            <td>Empresa</td>
                                        ...
                                        <tr>
                                            ...
                                            <td><%= obclsEstadoPosibleCliente.getStDescription()%></td>
                                            <td><%= obclssector.getStDescription()%></td>
                                            <td><%= item.getInCantidadEmpleados()%></td>
                                            <td><%= item.getDbIngresosAnuales()%></td>
                                            <td><%= obclscalificacion.getStDescription()%></td>
                                        ...
                                        <a class="btn btn-success btn-sm"
                                           href="PosibleClientesController?stOpcion=M&codigoSeleccionado=<%= item.getInCodigo() %>">
                                            Modificar</a>
                                            <a class="btn btn-danger btn-sm"
                                           href="PosibleClientesController?stOpcion=E&codigoSeleccionado=<%= item.getInCodigo() %>">
                                            Eliminar</a>
